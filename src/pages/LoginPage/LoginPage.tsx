...
import { signInWithEmailAndPassword, signOut, User, AuthError } from 'firebase/auth';
...
async function logoutUser(navigate: ReturnType<typeof useNavigate>): Promise<void> {
  try {
    await signOut(auth);
