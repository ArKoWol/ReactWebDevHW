...
export function MenuPage({ onAddToCart, menuData, categories }: MenuPageProps): React.ReactElement {
  const numberOfVisibleMeals = 6;
  const [selectedMenu, setSelectedMenu] = useState<string>('');
  const [visibleCount, setVisibleCount] = useState<number>(numberOfVisibleMeals);
